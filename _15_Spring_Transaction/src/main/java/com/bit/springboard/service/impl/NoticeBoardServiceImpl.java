...
import com.bit.springboard.dao.NoticeBoardDaoFieldVar;
...
public class NoticeBoardServiceImpl implements BoardService {
    private NoticeBoardDaoFieldVar noticeBoardDao;

    @Autowired
    public NoticeBoardServiceImpl(NoticeBoardDaoFieldVar noticeBoardDao) {
