...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/jquery-3.7.1.min.js"></script></head>
<body>
...
<%--**********************************************************************************
                    <!--a 태그는 get 방식으로 요청이 간다.->
**************************************************************************************--%>
                        </c:otherwise>
                    </c:choose>
                </ul>
<%--                .do 를 관례적으로 사용하지만, 쿠팡에서는.pang 을 쓴다.--%>
<%--                web.xml에서 DispatcherServlet 을 타고 들어가서 보면 doGet 과같은 메서드 존재--%>
            </div>
        </nav>
    </header>
</body>
